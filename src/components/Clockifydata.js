                        ...
                        <table className="min-w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-center text-gray-900 uppercase border-b border-gray-200 bg-gray-50">Week Ending</th>
                                    <th className="px-8 py-3 text-xs font-medium leading-4 tracking-wider text-center text-gray-900 uppercase border-b border-gray-200 bg-gray-50">Logged Hours</th>
                                </tr>
                                {data.map((data) => (
                                    <tr key={data}>
                                        <th className="px-8 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 border-b border-gray-200">{data.Project}</th>
                                        <th className="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-center text-gray-500 border-b border-gray-200">{data.User}</th>
                                        <th className="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-center text-gray-500 border-b border-gray-200">{data.Week}</th>
                                        <th className="px-8 py-3 text-xs font-medium leading-4 tracking-wider text-center text-gray-500 border-b border-gray-200">{formatTime(data['Time (decimal)'])}</th>
                                    </tr>
                                ))}
                            </thead>
                        </table>
