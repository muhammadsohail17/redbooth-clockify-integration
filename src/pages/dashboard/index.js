            ...
            <div className="px-4 py-2 bg-gray-200 bg-indigo-600 lg:w-1/4">
                ...
                <div className="my-2">
                    ...
                    <Link href="/api/auth/signout">
                        <span className=''>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-9 ml-3 mb-4 inline text-white  hover:text-red-400 cursor-pointer absolute bottom-0 left-0">
                                ...
                                <table className="min-w-full">
                                    ...
                                    <tbody className="bg-white">
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div className="text-sm leading-5 text-gray-500">CX : Interneships</div>
                                            </td>

                                            <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <span
                                                    className="inline-flex px-2 text-xs font-semibold leading-5 text-green-800">22/06/2023</span>
                                            </td>

                                            <td className="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                                                <span
                                                    className="inline-flex px-2 text-xs font-semibold">123</span>
                                            </td>
                                            <td
